	...
	<header class="header-v2">
		...
		<div class="container-menu-desktop trans-03">
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo">
						<img src="frontend/images/logo.jpg" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="frontend/images/logo.jpg" alt="IMG-LOGO"></a>
			</div>
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							{{-- <li @if ($title === 'Blogs')class="active-menu" @endif>
								<a href="blogs">Blog</a>
							</li> --}}
            ...
            <div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						...
						<li class="p-b-10">
							<a href="mobil" class="stext-107 cl7 hov-cl1 trans-04">
								Cars
							</a>
						</li>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					<h4 class="stext-301 cl0 p-b-30">
						...
						<div class="wrap-input1 w-full p-b-4">
							<a href="mailto:Ikhsan.new69@gmail.com?subject=permintaan%20sewa%20mobil&body=halo,%20saya%20mau%20sewa%20mobil.%0A%0Anama%20:%20%0Atanggal%20sewa%20:%20%0Adurasi%20sewa%20:%20%0Atipe%20mobil%20yang%20diinginkan%20:%20%0A%0Amohon%20dikonfirmasi.%20terima%20kasih!" 
   							class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04">Email</a>
						</div>

						<div class="p-t-4">
							<a href="https://wa.me/6282130875875?text=*PERMINTAAN%20SEWA%20MOBIL*%0AHallo,%20Saya%20Mau%20Sewa%20Mobil%2BDriver%0A%0ANama%20:%20%0ATanggal%20Sewa%20:%20%0ADurasi%20Sewa%20:%20%0ATipe%20Mobil%20Yang%20Diinginkan%20:%20%0ATujuan%20:%20%0A%0AMohon%20Dikonfirmasi.%20Terima%20kasih!" target="_blank" class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04">whatsapp</a>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="frontend/images/alphard.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="frontend/images/alphard.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="frontend/images/alphard.jpg">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<span class="mtext-106 cl2">
								IDR 2.700.000 / 12 JAM ALL INCLUED
							</span>

							<p class="stext-102 cl3 p-t-23">
								SUDAH TERMASUK BBM PARKIR & TOL
							</p>
							<p class="stext-102 cl3 p-t-23">
								TIDAK TERMASUK TIP DRIVER
							</p>
...
<!--===============================================================================================-->
	...
	<script src="frontend/js/map-custom.js"></script>
